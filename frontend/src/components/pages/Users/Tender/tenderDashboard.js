...
const TenderDashboard = () => {
    ...
    const validateOrderDetails = () => {
        ...
        if (selectedTender && orderDetails.quantity > selectedTender.requestId.newItemRequestCount) {
                                        ...
                                        <TableBody>
                                            {currentTenders.map((tender) => (
                                                <TableRow key={tender._id} hover>
                                                    ...
                                                    <TableCell>
                                                        <Typography>{tender.title}</Typography>
                                                        <Typography variant="body2" color="text.secondary">
                                                            {tender.details.substring(0, 50)}...
                                                        </Typography>
                                                    </TableCell>
                                                    <TableCell>
                                                        <Chip
                            ...
                            <Box sx={{
                                ...
                                <Box>
                                    ...
                                    <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                                        Reference: <strong>{selectedTender.referenceNo}</strong> • Category: <strong>{selectedTender.category}</strong>
                                    </Typography>
                                </Box>
                                <Box sx={{ display: 'flex', gap: 1 }}>
                                    <StatusChip
                                    ...
                                    <Paper elevation={0} sx={{
                                                ...
                                                <Grid item xs={6}>
                                                    <Box sx={{
                                                        ...
                                                        <Typography sx={{ display: 'flex', alignItems: 'center' }}>
                                                            ...
                                                            {formatDate(selectedTender.startingDate)}
                                                        </Typography>
                                                    </Box>
                                                </Grid>
                                                <Grid item xs={6}>
                                        ...
                                        <Box sx={{
                                            ...
                                            <Avatar sx={{
                                                ...
                                                {selectedTender.createdBy.fullName.charAt(0)}
                                            </Avatar>
                                            <Box>
                                                <Typography sx={{ fontWeight: 600 }}>
                                                    {selectedTender.createdBy.fullName}
                                                </Typography>
                                                <Typography variant="body2" color="text.secondary">
                                                    {selectedTender.createdBy.email}
                                                </Typography>
                                                <Typography variant="caption" display="block" color="text.secondary">
                                            ...
                                            <AccordionDetails sx={{ pt: 2 }}>
                                                <Grid container spacing={2}>
                                                    <Grid item xs={6}>
                                                        <InfoRow
                                                            label="Title"
                                                            value={selectedTender.requestId.title}
                                                        />
                                                    </Grid>
                                                    <Grid item xs={6}>
                                                        <InfoRow
                                                            label="Sub Category"
                                                            value={selectedTender.requestId.subCategory}
                                                        />
                                                    </Grid>
                                                    <Grid item xs={6}>
                                                        <InfoRow
                                                            label="Color"
                                                            value={selectedTender.requestId.colorPickup}
                                                        />
                                                    </Grid>
                                                    <Grid item xs={6}>
                                                        <InfoRow
                                                            label="Current Qty"
                                                            value={selectedTender.requestId.currentItemCount}
                                                        />
                                                    </Grid>
                                                    <Grid item xs={6}>
                                                        <InfoRow
                                                            label="Damaged Qty"
                                                            value={selectedTender.requestId.damagedItemCount}
                                                        />
                                                    </Grid>
                                                    <Grid item xs={6}>
                                                        <InfoRow
                                                            label="Requested Qty"
                                                            value={selectedTender.requestId.newItemRequestCount}
                                                        />
                                                    </Grid>
                                                </Grid>
                                            </AccordionDetails>
                                                    ...
                                                    <Grid item xs={12} md={6}>
                                                        <TextField
                                                            ...
                                                            InputProps={{
                                                                inputProps: {
                                                                    min: 1,
                                                                    max: selectedTender.requestId.newItemRequestCount
                                                                }
                                                            }}
                                                            sx={{ mb: 2 }}
                                                        />
